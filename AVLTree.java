...
public class AVLTree<E extends Comparable<E>> extends Tree<E> implements Collection<E> {
    ...
    private boolean addAVL(AVLNode<E> r, AVLNode<E> p, boolean g, Comparable e){
        if (r == null) {
            ...
            if (a < 0)
                ...
                if(addAVL(r.right, r, false, e)) return rotateRight(r, p, g);
                else return false;
        }
    }
    ...
    private boolean rotateRight (AVLNode<E> r, AVLNode<E> p, boolean g){
        ...
        AVLNode<E> r1, r2;
        switch(r.imbalance){
            case -1 : r.setImbalance(0); return false;
            case  0 : r.setImbalance(1); return true;
            case  1 :
            default : r1 = r.getRight();
	            if (r1.getImbalance() == 1) {
		            ...
		            r2 = r1.left; r1.left = r2.right;
		            r2.right = r1;
		            r.right = r2.left; r2.right = r;
    ...
    private boolean rotateLeft (AVLNode<E> r, AVLNode<E> p, boolean g){
        ...
        AVLNode<E> r1, r2;
        switch (r.imbalance){
            case 1 : r.imbalance = 0; return false;  
            case 0 : r.imbalance = -1; return true;  
            case -1 :
            default : r1 = r.left;
	            if (r1.imbalance == -1){
	                r.left = r1.right; r1.right = r; 
	                r.imbalance = 0; r = r1;
	            } else { 
	                r2 = r1.right; r1.right = r2.left; r2.left=r1; 
	                r.left=r2.right; r2.right = r; 
	                if(r2.imbalance == -1) r.imbalance = 1; 
	                else                   r.imbalance = 0;
	                if(r2.imbalance == 1)  r1.imbalance = -1; 
	                else                   r1.imbalance = 0; 
